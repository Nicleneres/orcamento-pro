...
<head>
    ...
    <title>Cadastro - Orçamento PRO</title>
...
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-md bg-white/10 backdrop-blur-md rounded-2xl shadow-xl p-8 animate-fade-in-up">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-300 text-lg mt-1">Crie sua Conta</p>
        </div>
        ...
        <form action="processar_registro.php" method="POST">
            <div class="mb-4">
                ...
                <input type="text" name="nome" id="nome" class="p-3 w-full rounded-lg bg-gray-900/50 text-white border border-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" required>
            </div>
            <div class="mb-4">
            ...
            <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95">
                Cadastrar
            </button>
        </form>

        <div class="text-center mt-6">
            <a href="login.php" class="text-sm text-indigo-300 hover:text-indigo-100 transition">Já tem uma conta? Faça login</a>
        </div>
